    ...
    <div className="px-5 py-6">
      ...
      <div className="space-y-3">
        {FORM_FIELDS_CONFIG.map((item) => (
          <div key={item.field} className={`dropdown-container h-[56px] bg-[#121212] rounded-lg border border-[#3A3A3A] flex items-center relative ${'isDropdown' in item && item.isDropdown ? 'overflow-visible' : ''}`}>
