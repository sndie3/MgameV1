...
export default function BetLimitView() {
  ...
  const handleSubmit = () => {
    ...
    if (customAmount && customValue > MAX_AMOUNT) {
      showModal('warning', 'Amount Too High', `Maximum bet limit is ${MAX_AMOUNT.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}.`);
      return;
    }
    ...
    <div className="min-h-screen text-white flex flex-col bg-black font-bahnschrift">
      ...
      <div className="px-5 pt-6 pb-6 bg-[#121212]">
        <div className="relative flex items-center justify-center">
          ...
          <h1 className="text-[24px] font-semibold uppercase">Bet Limit</h1>
        </div>
      </div>
