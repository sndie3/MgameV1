...
export default function CashInLimitView() {
  ...
  const handleSubmit = () => {
    ...
    showModal('success', 'Cash-In Limit Set', `Your cash-in limit has been set to ${amount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}.`);
  };
